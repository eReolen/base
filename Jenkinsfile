    ...
    stages {
        ...
        stage('Deployment develop') {
            ...
            steps {
                ...
                sh "ansible devereolen -m shell -a 'cd /home/deploy/www/dev_ereolen_dk/htdocs/sites/all/modules/ereol; git checkout release'"
        ...
        stage('Deployment production') {
            ...
            steps {
                ...
                sh "ansible ereolen -m shell -a 'cd /home/deploy/www/ereolen_dk/htdocs/sites/all/modules/ereol; git checkout release'"
