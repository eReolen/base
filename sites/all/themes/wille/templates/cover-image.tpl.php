...
<?php elseif ($node->type === 'breol_news') : ?>

  <div class="article--<?php print $node->type; ?>">
    <div class="article--<?php print $node->type; ?>--page">
      <div class="article--<?php print $node->type; ?>--title">
        <h1 class="title"><?php print $node->title; ?></h1>
      </div>
      <div class="article--<?php print $node->type; ?>--image">
        <?php if (!empty($image)) : ?>
          <?php print $image; ?>
        <?php endif; ?>
      </div>
      <div class="article--<?php print $node->type?>--content">
