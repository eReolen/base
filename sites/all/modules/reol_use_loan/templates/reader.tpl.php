...
<body>
<div data-id="<?php echo $retailer_order_number; ?>" id="reader-container" data-url="<?php echo variable_get('publizon_reader_stream_url', ''); ?>" data-images-url="<?php echo variable_get('publizon_reader_url', ''); ?>"></div>
