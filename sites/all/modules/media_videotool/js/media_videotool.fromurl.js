...
/**
 *  @file
 *  Create the 'VideoTool' tab for the WYSIWYG plugins.
 */

// (function ($) {
//   namespace('Drupal.media.browser.plugin');
//
//   Drupal.media.browser.plugin.media_videotool = function(mediaBrowser, options) {
//     return {
//       init: function() {
//         tabset = mediaBrowser.getTabset();
//         tabset.tabs('add', '#media_videotool', 'VideoTool');
//         mediaBrowser.listen('tabs.show', function (e, id) {
//           if (id == 'media_videotool') {
//             // We only need to set this once.
//             // We probably could set it upon load.
//             if (mediaBrowser.getActivePanel().html() == '') {
//               mediaBrowser.getActivePanel().html(options.media_videotool);
//             }
//           }
//         });
//       }
...
//   //@todo: needs a review.
//   Drupal.media.browser.register('media_videotool', Drupal.media.browser.plugin.media_videotool, {});
// })(jQuery);

(function ($) {
  namespace('media.browser.plugin');

  Drupal.media.browser.plugin.videotool_library = function(mediaBrowser, options) {

    return {
      mediaFiles: [],
      init: function() {
        tabset = mediaBrowser.getTabset();
        tabset.tabs('add', '#videotool_library', 'VideoTool');
        var that = this;
        mediaBrowser.listen('tabs.show', function (e, id) {
          if (id == 'videotool_library') {
  ...
  Drupal.media.browser.register('videotool_library', Drupal.media.browser.plugin.videotool_library);
})(jQuery);
